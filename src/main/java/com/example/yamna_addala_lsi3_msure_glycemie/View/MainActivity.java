...
import com.example.yamna_addala_lsi3_msure_glycemie.controller.controller;
...
public class MainActivity extends AppCompatActivity {
    ...
    private controller controller = com.example.yamna_addala_lsi3_msure_glycemie.controller.controller.getInstance();
    @Override
        ...
        btnConsulter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (verifAge && verifValeur) {
                    ...
                    Intent intent = new Intent(MainActivity.this, ConsultActivity2.class);
